...
const clouds = [
  ...
  // Placeholder entries for projects 11-16 — replace image/fullImage/label/description/href/top/duration as needed
  {
    shape: 'cloud2',
    displayW: 360,
    image: '/Thumbs/Library-18x24.webp',
    fullImage: '/Full-Q/Library-18x24.webp',
    label: 'Library 1-Point',
    description: 'Linear (1-Point) Perspective drawing showcasing detailed view of a quiet moment in a library for the subject.',
    href: '#project-11',
    top: '22%',
    duration: 80,
  },
  {
    shape: 'cloud1',
    displayW: 320,
    image: '/Thumbs/Nude-Full-Body-11x14.webp',
    fullImage: '/Full-Q/Nude-Full-Body-11x14.webp',
    label: 'Full Body Male Nude',
    description: 'Contemplative nude portrait in graphite illustrating human male anatomy.',
    href: '#project-12',
    top: '45%',
    duration: 88,
  },
  {
    shape: 'cloud4',
    displayW: 400,
    image: '/Thumbs/Color-Portrait-18x24.webp',
    fullImage: '/Full-Q/Color-Portrait-18x24.webp',
    label: 'Oil Pastel Color Portrait',
  ...
  },
  {
    shape: 'cloud3',
    displayW: 380,
    image: '/Thumbs/Color-Still-Life-8x10.webp',
    fullImage: '/Full-Q/Color-Still-Life-8x10.webp',
    label: 'Bowl of Fruit',
  ...
  },
  {
    shape: 'cloud2',
    displayW: 350,
    image: '/Thumbs/BW-Still-Life-9x12.webp',
    fullImage: '/Full-Q/BW-Still-Life-9x12.webp',
    label: 'Graphite Still Life',
    description: 'Graphite pencil drawing of a still life scene.',
    href: '#project-15',
    top: '15%',
    duration: 82,
  },
  {
    shape: 'cloud1',
    displayW: 420,
    image: '/Thumbs/Farmhouse-18x24.webp',
    fullImage: '/Full-Q/Farmhouse-18x24.webp',
    label: 'Farmhouse 2-Point',
    description: '2-Point linear perspective piece of a farmhouse scene, showcasing the power of negative space in the context of expansive perspective.',
    href: '#project-16',
    top: '33%',
    duration: 99,
  },
